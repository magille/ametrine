  ...
  return (
    <section className="bg-primary-900 text-white">
      <div className="max-w-[90rem] mx-auto px-6 py-20">
        <p className="font-heading uppercase tracking-widest text-sm font-semibold text-brandBlue-200 mb-4">
          {eyebrow}
        </p>
        <h2 className="text-4xl md:text-5xl font-bold leading-[0.95] max-w-3xl mb-6">{title}</h2>
        <p className="text-brandBlue-100 text-lg max-w-2xl mb-10">{body}</p>
