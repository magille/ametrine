      ...
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-16">
        <div className="grid md:grid-cols-2 gap-10 md:gap-14 items-center">
          <div>
            ...
            <h1 className="text-5xl md:text-6xl font-bold leading-[0.92]">
              <span className="text-ink">{home.hero.headlineTop}</span>{" "}
              <span className="text-primary">{home.hero.headlineAccent}</span>
            </h1>
            <p className="text-lg text-neutral-600 max-w-xl mt-8">{home.hero.body}</p>
          ...
          <DuotoneImage src={heroPhoto} alt="Field research and evaluation in progress" ratio="aspect-[4/5]" />
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            ...
            <DuotoneImage src={whoWeArePhoto} alt="Team at work in the field" ratio="aspect-[4/3]" className="mt-7" />
          </div>
          <div>
            ...
            <div className="flex flex-wrap content-start gap-3 mt-7">
